...
export default function Hero() {
  return (
    <section className="relative flex min-h-[90vh] flex-col justify-center px-5 overflow-hidden">
      <div className="absolute top-16 right-6 text-6xl opacity-15 text-accent select-none font-script leading-none">
        ✦
      </div>
      <div className="absolute bottom-36 left-4 text-5xl opacity-10 text-secondary select-none font-script leading-none">
        ❀
      </div>
      <div className="absolute top-1/3 left-1/2 -translate-x-1/2 text-7xl opacity-[0.04] text-primary select-none font-script leading-none pointer-events-none">
        Rishita Ke Rang
      </div>
